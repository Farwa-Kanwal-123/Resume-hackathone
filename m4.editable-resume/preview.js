class ResumePreview {
    constructor() {
        ...
        if (!this.container || !this.editModeBtn || !this.saveChangesBtn) {
    ...
    toggleEditMode() {
        ...
        console.log('Edit mode:', this.editMode); // Debug log
    ...
    toggleEditableContent() {
        ...
        console.log('Editable elements found:', editableElements.length); // Debug log
